...
import {
  ...
  Folder, ShieldAlert, UserPlus, Users
} from 'lucide-react';
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex items-center justify-between mb-10">
        ...
        <div className="flex items-center gap-3">
          {(showProvisionForm || activeTab === 'logs') ? (
            <button
              onClick={() => { setActiveTab('users'); setShowProvisionForm(false); }}
              className="px-5 h-11 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2 bg-white/5 text-gray-400 hover:bg-white/10 hover:text-white ring-1 ring-white/10"
            >
            ...
            <>
              <button
                onClick={() => { setActiveTab('users'); setShowProvisionForm(true); }}
                className="px-5 h-11 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2 bg-blue-600 text-white shadow-lg shadow-blue-600/20 hover:bg-blue-500"
              >
              ...
              <button
                onClick={() => { setActiveTab('logs'); setShowProvisionForm(false); }}
                className="px-5 h-11 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2 ring-1 ring-white/10 bg-white/5 text-gray-400 hover:bg-white/10 hover:text-white"
              >
          ...
          <div className="max-w-lg mx-auto">
            ...
            >
              <div className="glass-card p-10 ring-1 ring-white/10 shadow-3xl">
                <h3 className="text-lg font-black text-white mb-8">User Credentials</h3>
                <form onSubmit={handleCreateUser} className="space-y-6">
                  ...
                  <div className="space-y-4 text-left">
                    <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 ml-1">Role</label>
                    <CustomSelect
                      value={newUser.role}
              ...
              <tbody className="divide-y divide-white/5 font-mono">
                {logs.map((l, i) => (
                  <tr key={i} className={cn("hover:bg-white/5 transition-colors", l.is_suspicious ? "bg-rose-500/[0.03]" : "")}>
                    ...
                    <td className="px-8 py-5 text-sm text-blue-400 font-bold">{l.user_name || l.user_email}</td>
    ...
    <div className="min-h-screen relative flex">
      <aside className="fixed left-0 top-0 bottom-0 w-72 bg-[#0A0A0A]/95 backdrop-blur-2xl border-r border-white/5 flex flex-col z-[100]">
        ...
        <div className="p-4 border-t border-white/5 space-y-2">
          {currentStage === 2 && !showAdmin && !showCollections && (
            <button
